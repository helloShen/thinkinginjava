...
chapter: Chapter 13
description: >
  (5) Modify JGrep.java to accept a directory name or a file name as argument (if a directory is provided, search should include all files in the directory). Hint: You can generate a list of file names with: `File[] files = new File(".").listFiles();`
---
