---
layout: post
title: "【转】面向切面编程(AOP) - 续"
chapter: "Chapter 20"
description: >
  继续转载黄勇的《AOP那点事》。在上篇中，我们从写死代码，到使用代理；从编程式 Spring AOP 到声明式 Spring AOP。一切都朝着简单实用主义的方向在发展。沿着 Spring AOP 的方向，Rod Johnson（老罗）花了不少心思，都是为了让我们使用 Spring 框架时不会感受到麻烦，但事实却并非如此。那么，后来老罗究竟对 Spring AOP 做了哪些改进呢？现在继续！
---
...
![spring](/jekyll_bootstrap_demo/uploads/tij4-20/spring.png)
