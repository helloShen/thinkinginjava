...
public class TestVim{
    ...
    class TestClass {
        ...
        public String insert(int num, String str){
            if(num>=0 && num<=name.length()){
                String h1=name.substring(0,num);
                String h2=name.substring(num,name.length());
                return h1+str+h2;
            }
            System.out.println("We can not insert into this place!");
            return name;
        }
    }
        ...
        public void run() {
            try {
                while(!Thread.interrupted()) {
                    ...
                    // Insert into queue carQueue.put(c);
                }
    ...
    public static void main(String[] args) throws Exception {
       ...
       TestClass myClass=test.new TestClass("helloworld");
       System.out.println(myClass.insert(3,"shenwei"));
    }
}
