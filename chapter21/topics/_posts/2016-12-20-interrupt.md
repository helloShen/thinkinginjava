...
chapter: "Chapter 21"
description: >
  Java并发中的interrupt的行为，一直非常诡异。我并不是在亵渎Java，只是说要掌握并发编程，Interrupt的脾气一定要先摸清楚。这里转一篇**Brian Goetz**的一篇技术文章《Java 理论与实践: 处理 InterruptedException》，涉及到Java并发，全世界值得信任的名字真的不多。
---
...
Brian Goetz的《Java理论与实践：处理InterruptedException》，原文刊发在IBM开发者论坛：[**《Java 理论与实践: 处理 InterruptedException》**](http://www.ibm.com/developerworks/cn/java/j-jtp05236.html)。
